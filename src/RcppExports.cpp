...
static SEXP _lwgeom_CPL_read_wkb_try(SEXP wkb_listSEXP, SEXP EWKBSEXP, SEXP spatialiteSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
...
RcppExport SEXP _lwgeom_CPL_read_wkb(SEXP wkb_listSEXP, SEXP EWKBSEXP, SEXP spatialiteSEXP) {
    ...
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_lwgeom_CPL_read_wkb_try(wkb_listSEXP, EWKBSEXP, spatialiteSEXP));
    }
...
static SEXP _lwgeom_CPL_write_wkb_try(SEXP sfcSEXP, SEXP EWKBSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type sfc(sfcSEXP);
    Rcpp::traits::input_parameter< bool >::type EWKB(EWKBSEXP);
...
RcppExport SEXP _lwgeom_CPL_write_wkb(SEXP sfcSEXP, SEXP EWKBSEXP) {
    ...
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_lwgeom_CPL_write_wkb_try(sfcSEXP, EWKBSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _lwgeom_RcppExport_validate(const char* sig) { 
...
RcppExport SEXP _lwgeom_RcppExport_registerCCallable() { 
    R_RegisterCCallable("lwgeom", "_lwgeom_CPL_read_wkb", (DL_FUNC)_lwgeom_CPL_read_wkb_try);
    R_RegisterCCallable("lwgeom", "_lwgeom_CPL_write_wkb", (DL_FUNC)_lwgeom_CPL_write_wkb_try);
    R_RegisterCCallable("lwgeom", "_lwgeom_RcppExport_validate", (DL_FUNC)_lwgeom_RcppExport_validate);
    return R_NilValue;
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_lwgeom_RcppExport_registerCCallable", (DL_FUNC) &_lwgeom_RcppExport_registerCCallable, 0},
    {NULL, NULL, 0}
};
